...
const translations = {
  ...
  obj_title: "الأهداف",
    ...
    facility_text1: "تتمتع الوحدة التنفيذية للمشاريع الممولة خارجيًا بأعلى معايير الكفاءة والجودة، حيث خضعت عملياتها وأنظمتها لتقييم شامل بواسطه البنك الدولي و UNOPS يغطي إدارة الموارد المالية، إجراءات الشراء والمناقصات، وأطر متابعة المشاريع، لضمان توافق الممارسات مع المعايير الدولية وتعزيز إدارة المشاريع الممولة دوليًا.",
